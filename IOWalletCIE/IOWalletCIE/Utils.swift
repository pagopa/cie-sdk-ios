...
class Utils {
    public static func generateRandomUInt8Array( _ size: Int ) -> [UInt8] {
    ...
    public static func wrapDO( b : UInt8, arr : [UInt8] ) -> [UInt8] {
    ...
    @available(iOS 13, macOS 10.15, *)
    public static func wrapDO1( b : UInt16, arr : [UInt8] ) -> [UInt8] {
        let tag = TKBERTLVRecord(tag: TKTLVTag(b), value: Data(arr))
        let result = [UInt8](tag.data)
        return result;
    }
    ...
    @available(iOS 13, macOS 10.15, *)
    public static func calcSHA256Hash( _ data: [UInt8] ) -> [UInt8] {
        var sha256 = SHA256()
    ...
    public static func intToBin(_ data : Int, pad : Int = 2) -> [UInt8] {
        let hexFormat = "%0\(pad)x"
        return [UInt8](hex: String(format: hexFormat, data))!
    }
    
    public static func pad(_ toPad : [UInt8], blockSize : Int) -> [UInt8] {
    ...
    public static func unpad( _ tounpad : [UInt8]) -> [UInt8] {
    ...
    @available(iOS 13, macOS 10.15, *)
    public static func desMAC(key : [UInt8], msg : [UInt8]) throws -> [UInt8]{
