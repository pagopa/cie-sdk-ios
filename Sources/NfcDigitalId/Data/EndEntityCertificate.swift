...
struct EndEntityCertificate {
    ...
    init(extAuthParameters: DiffieHellmanExternalParameters) throws {
        ...
        let signature = try RSAWithIASECCPadding.encrypt(keyValue: extAuthParameters.privateKey, blob: IASECCPadding(recovery: certificateRemainder, hash: certificateHash))
