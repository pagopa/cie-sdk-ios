...
struct RFC5114 {
    ...
    static func DH_get_1024_160() -> OpaquePointer? {
        return DH_1024_160.DH()
    }
    
    
    static func DH_get_2048_224() -> OpaquePointer? {
        return DH_2048_224.DH()
    }
    
    
    static func DH_get_2048_256() -> OpaquePointer? {
        return DH_2048_256.DH()
    }
    
    static var DH_1024_160: DiffieHellmanParameters {
    ...
    static var DH_2048_224: DiffieHellmanParameters {
        return DiffieHellmanParameters(
            g: [
    ...
    static var DH_2048_256: DiffieHellmanParameters {
        return DiffieHellmanParameters(
            g: [
