...
enum SecurityEnvironmentControlReference : UInt8 {
    ...
    case MSE_SET_EXT_AUTH_AND_INT_AUTH = 0xC1
...
enum FileId : String {
    ...
    case emrtd           = "A0000002471001" //eMRTD
    
    
    case cardAccess      = "011C"
...
class Constants {
    ...
    static let publicKeyInfoId: ASN1Identifier = ASN1Identifier(tagWithNumber: 17, tagClass: .universal)
    static let algorithmId: ASN1Identifier = ASN1Identifier(tagWithNumber: 16, tagClass: .universal)
    static let algorithmOidId: ASN1Identifier = ASN1Identifier(tagWithNumber: 6, tagClass: .universal)
   
    static let nonceContainer: ASN1Identifier = ASN1Identifier(tagWithNumber: 28, tagClass: .application)
