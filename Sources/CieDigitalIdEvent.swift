...
public enum CieDigitalIdEvent {
    ...
    case EMRTD_AUTHENTICATE_KEY_AGREEMENT
    case EMRTD_AUTHENTICATE_REQUEST_NONCE
    case EMRTD_AUTHENTICATE_SEND_PUBLICKEY
    case EMRTD_AUTHENTICATE_KEY_EXCHANGE
    case EMRTD_AUTHENTICATE_TOKEN
    case READ_EMRTD_DATA(String)
}
